...
public partial class SmileOnMePage : ContentPage
{
    bool _isHowToPlayOpen;
    bool _isAnimating;

    public SmileOnMePage()
    {
        InitializeComponent();
    }
    ...
    {
        base.OnAppearing();
        int bestScore = BrainScoreService.GetGamePerformance("smile_on_me")?.BestScore ?? 0;
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => ArcadeChallengeFactory.Create("Smile On Me"));
    }
