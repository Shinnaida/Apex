...
public partial class DecoderPage : ContentPage
{
    ...
    protected override void OnAppearing()
    {
        ...
        int bestScore = BrainScoreService.GetGamePerformance("decoder")?.BestScore ?? 0;
        BestScoreLabel.Text = bestScore.ToString();
        BestRankLabel.Text = DecoderProgress.ResolveRank(bestScore);
        ChallengeLabel.Text = DecoderProgress.ResolveChallenge(bestScore);
    }
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => new DecoderGamePage());
    }
