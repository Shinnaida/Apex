...
public partial class GrowPage : ContentPage
{
    ...
    {
        base.OnAppearing();
        BestScoreValueLabel.Text = (BrainScoreService.GetGamePerformance("grow")?.BestScore ?? 0).ToString();
    }
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => new GrowGamePage());
    }
