...
public partial class BabbleBotsPage : ContentPage
{
    bool _isHowToPlayOpen;
    bool _isAnimating;

    public BabbleBotsPage()
    {
        InitializeComponent();
    }
    ...
    {
        base.OnAppearing();
        BestScoreValueLabel.Text = (BrainScoreService.GetGamePerformance("babble_bots")?.BestScore ?? 0).ToString();
    }
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => new BabbleBotsGamePage());
    }
