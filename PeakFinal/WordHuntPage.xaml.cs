...
public partial class WordHuntPage : ContentPage
{
    ...
    {
        base.OnAppearing();
        BestScoreValueLabel.Text = (BrainScoreService.GetGamePerformance("word_hunt")?.BestScore ?? 0).ToString();
    }
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => new WordHuntGamePage());
    }
