...
public partial class TapTrapPage : ContentPage
{
    ...
    protected override void OnAppearing()
    {
        ...
        int bestScore = BrainScoreService.GetGamePerformance("tap_trap")?.BestScore ?? 0;
        BestScoreLabel.Text = bestScore.ToString();
        BestRankLabel.Text = TapTrapProgress.ResolveRank(bestScore);
        ChallengeLabel.Text = TapTrapProgress.ResolveChallenge(bestScore);
    }
