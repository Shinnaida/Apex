...
public partial class WordFreshPage : ContentPage
{
    bool _isHowToPlayOpen;
    bool _isAnimating;

    public WordFreshPage()
    {
        InitializeComponent();
    }
    ...
    protected override void OnAppearing()
    {
        ...
        int bestScore = BrainScoreService.GetGamePerformance("word_fresh")?.BestScore ?? 0;
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => new WordFreshGamePage());
    }
