...
public partial class SquareNumbersPage : ContentPage
{
    bool _isHowToPlayOpen;
    bool _isAnimating;

    public SquareNumbersPage()
    {
        InitializeComponent();
    }
    ...
    protected override void OnAppearing()
    {
        ...
        int bestScore = BrainScoreService.GetGamePerformance("square_numbers")?.BestScore ?? 0;
        BestScoreLabel.Text = bestScore.ToString();
        BestRankLabel.Text = SquareNumbersProgress.ResolveRank(bestScore);
        ChallengeLabel.Text = SquareNumbersProgress.ResolveChallenge(bestScore);
    }
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => new SquareNumbersGamePage());
    }
