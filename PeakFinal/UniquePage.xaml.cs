...
public partial class UniquePage : ContentPage
{
    ...
    protected override void OnAppearing()
    {
        ...
        int bestScore = BrainScoreService.GetGamePerformance("unique")?.BestScore ?? 0;
        BestScoreLabel.Text = bestScore.ToString();
        BestRankLabel.Text = UniqueProgress.ResolveRank(bestScore);
        ChallengeLabel.Text = UniqueProgress.ResolveChallenge(bestScore);
    }
