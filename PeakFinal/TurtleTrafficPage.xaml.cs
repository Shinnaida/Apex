...
public partial class TurtleTrafficPage : ContentPage
{
    bool _isHowToPlayOpen;
    bool _isAnimating;

    public TurtleTrafficPage()
    {
        InitializeComponent();
    }
    ...
    {
        await PageTransitionService.PushAsync(Navigation, () => new TurtleTrafficGamePage());
    }
