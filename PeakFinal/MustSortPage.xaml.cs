...
public partial class MustSortPage : ContentPage
{
    ...
    protected override void OnAppearing()
    {
        ...
        int bestScore = BrainScoreService.GetGamePerformance("must_sort")?.BestScore ?? 0;
        BestScoreLabel.Text = bestScore.ToString();
        BestRankLabel.Text = MustSortProgress.ResolveRank(bestScore);
        ChallengeLabel.Text = MustSortProgress.ResolveChallenge(bestScore);
    }
